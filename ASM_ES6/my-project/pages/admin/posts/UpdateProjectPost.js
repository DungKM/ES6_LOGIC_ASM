              ...
              <div class="bg-light rounded h-100 p-4">
                  ...
                  <form id="form-add">
                      <div class="mb-3">
                          ...
                          <input type="text" class="form-control" value="${data.title}" id="exampleInputTitle"
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" class="form-control" value="${data.content}" id="exampleInputContent">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputAuthor" class="form-label">Author</label>
                          <input type="text" class="form-control" value="${data.author}" id="exampleInputAuthor">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputYear" class="form-label">Years of experience</label>
                          <input type="number" class="form-control" value="${data.years_of_experience}" id="exampleInputYear">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputSatis" class="form-label">Satisfied clients</label>
                          <input type="number" class="form-control" value="${data.satisfied_clients}" id="exampleInputSatis">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputWork" class="form-label">Working hours</label>
                          <input type="number" class="form-control" value="${data.working_hours}" id="exampleInputWork">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputAwards" class="form-label">Awards won</label>
                          <input type="number" class="form-control" value="${data.awards_won}" id="exampleInputAwards">
                      </div>
...
export default EditProjectPost;
