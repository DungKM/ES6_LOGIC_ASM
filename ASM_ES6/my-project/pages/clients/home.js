...
<header class="header">
    <div class="user">
        <img src="pages/assets/image/user-img.png" alt="">
        <h3>shaikh anas</h3>
...
<section class="portfolio" id="portfolio">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="pages/assets/image/img-2.jpg" alt="">
            <div class="content">
                <h3>project 02</h3>
            </div>
        </div>
        ...
        <div class="box">
            <img src="pages/assets/image/img-3.jpg" alt="">
            <div class="content">
                <h3>project 03</h3>
            </div>
        </div>
        ...
        <div class="box">
            <img src="pages/assets/image/img-4.jpg" alt="">
            <div class="content">
                <h3>project 04</h3>
            </div>
        </div>
        ...
        <div class="box">
            <img src="pages/assets/image/img-5.jpg" alt="">
            <div class="content">
                <h3>project 05</h3>
            </div>
        </div>
        ...
        <div class="box">
            <img src="pages/assets/image/img-6.jpg" alt="">
            <div class="content">
                <h3>project 06</h3>
            </div>
        </div>
